					 ...
					 <div style="width:754px;margin-top: 1px;padding-bottom:5px;">
					      ...
					      <div style="border:1px solid #CCCCCC">
								   <TABLE class=main border=0 cellSpacing=9 cellPadding=9 height=115>
						              <TR>
						                  <c:forEach items="${requestScope.shoucangList}" var="shoucang" varStatus="sta">
							                  ...
							                  <TABLE onmouseover="this.style.backgroundColor='#FF6600'" onmouseout="this.style.backgroundColor=''" border=0 cellSpacing=1 cellPadding=2 bgColor=#e1e1e1>
							                    <TR>
							                      <TD bgColor=#ffffff  align="center">
							                           <center>
							                              <A href="<%=path %>/bookDetailQian.action?id=${shoucang.book.id}">
							                              <IMG border=0 src="<%=path %>/${shoucang.book.tupian}" width=172 height=200></A>
							                           </center>
							                           <center>
							                              <A href="<%=path %>/bookDetailQian.action?id=${shoucang.book.id}">
							                              <FONT color=#ff0000><c:out value="${fn:substring(shoucang.book.mingcheng, 0, 12)}" escapeXml="false"></c:out>..</FONT></A>
							                              <BR>
							                           <center>
							                      </TD>
							                    </TR>
